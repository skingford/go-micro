...
export class AppServiceProvider {
  public static BASE_DOMAIN = 'https://www.yilabao.cn/';
  public static BASE_API = 'api/';
   ...
   * 页面跳转
   */
  public push(url: string, json: any = {}): void {
  ...
  public getPageUrl(url: string, json: any = {}): string {
